...
//		(v) Say s is a parameter of type String, write appropriate type for variable c5
		UnaryOperator<String>  c5 = s -> s.charAt(0);
...
//		(vii) Look at the following code-
		...
		Supplier<Exception> c7 = ex::toString; ---- (a)
...
//		(ix) Look at the following code
		...
		Predicate<Set<Integer>> c9 = set::add;----(a)
		c9.test(5);----(b)
...
//		(x) Look at the following code
		...
		list.add("One");
		Predicate<List<String>> c10 = list::add; ----(a)
		c10.test("String"); ----(b)
...
//		If the specified key is not already associated with a value (or is mapped to null) associates it with the given value and returns null, else returns the current value.
		...
		Function<String, Integer> c11 = map::putIfAbsent; ----(a)
		c11.accept(); ----(b)
