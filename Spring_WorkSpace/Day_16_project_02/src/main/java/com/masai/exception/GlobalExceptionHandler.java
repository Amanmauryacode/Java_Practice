...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyDetailError> exception(UserException ee,WebRequest wr){
	...
	public ResponseEntity<MyDetailError> exception(EmailException ee,WebRequest wr){
