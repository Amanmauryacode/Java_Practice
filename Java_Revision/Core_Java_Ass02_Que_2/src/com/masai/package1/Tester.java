...
public class Tester {
	public static void main(String[] args) {
		String auctionDescriptions[] = { "91 DTB 13042023 6.35 100000", "182 DTB 13072023 6.75 250000",
				"364 DTB 11012024 6.89 89000" };
		...
		for (String auctionDesc : auctionDescriptions) {
			...
			try {
				double investmentAmount = TBillDemo
						.getInitialInvestementAmount(Double.parseDouble(auctionDesc.split(" ")[4]), auctionDesc);
